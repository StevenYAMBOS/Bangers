...
class TTextTheme {
  TTextTheme._(); // La syntaxe `._` signifie que la classe est privée. Les classes et les méthodes ne seront disponibles que dans le fichier .dart où elles sont définies. Ici ça nous évite de créer les instances.
